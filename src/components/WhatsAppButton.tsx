...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <div className="relative flex h-14 w-14 items-center justify-center rounded-full bg-green-500 shadow-lg shadow-green-500/40 hover:bg-green-400 hover:scale-110 transition-all duration-200">
        {/* Pulse ring */}
